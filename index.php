...
<html>
	<head>
		<title>WELCOME TO CYBERHUB  ONLINE RETAIL</title>
	...
	<body style="min-width: 980px;">
			...
			<div class="">
				<div id="srcheader">
					<form id="newsearch" method="get" action="search.php">
					        <input type="text" class="srctextinput" name="keywords" size="21" maxlength="120"  placeholder="Search for Products and More"><input type="submit" value="Search" class="srcbutton" >
					</form>
		...
		<div class="home-welcome">
			<div class="home-welcome-text" style="background-image: url(image/homebackgrndimg.png); height: 380px; ">
				<h1 style="margin: 0px;">WELCOME TO CYBERHUB</h1>
				<h2>Online Cyber Retail System by Rahul & Shubham!</h2>
				<h3>18BCE0018 & 18BCE0803</h3>
			</div>
		</div>
